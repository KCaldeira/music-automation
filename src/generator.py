...
def sample_next_start(current_step, division_start_list, steps_per_cycle,
                      step_length_scale, u):
    ...
    ext[:steps_per_cycle] = division_start_list
    ext[steps_per_cycle] = division_start_list[0]            # periodic extension placeholder
...
def should_terminate(pitch, current_step, division_start_list, max_attractiveness,
    ...
    step_weight = float(division_start_list[current_step])
    p_terminate = (
...
def generate_cycle(cfg, note_pitch_list, note_probability_list, division_start_list,
    ...
    while True:
        ...
        next_start = sample_next_start(
            current_step, division_start_list, steps_per_cycle,
        ...
        if should_terminate(
            pitch, current_step, division_start_list, max_attractiveness,
